...
RNA_DIR=${RNA_DIR:-datasets/pbmc_preprocessed}
ATAC_DIR=${ATAC_DIR:-datasets/pbmc_preprocessed}
CANDIDATE_JSON=${CANDIDATE_JSON:-$RNA_DIR/candidate_peaks.json}
TF_LIST=${TF_LIST:-datasets/pbmc_preprocessed/tf_list.txt}
POS_LINKS=${POS_LINKS:-datasets/dorothea_high_confidence_links_train.csv}
VAL_POS_LINKS=${VAL_POS_LINKS:-datasets/dorothea_high_confidence_links_val.csv}
OUTPUT_ROOT=${OUTPUT_ROOT:-output/pbmc_pipeline_$(date +%Y%m%d_%H%M%S)}
